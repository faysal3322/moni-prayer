...
class _HomeTabState extends State<_HomeTab> with WidgetsBindingObserver {
  ...
  List<Map<String, dynamic>> _getLiveAlerts(AppLanguage lang) {
    ...
    // ══ প্রতিদিন সকাল ১০টা - দুপুর ১২টা — চরিত্র, ইলম ও সমাজ-সংক্রান্ত আমল ══
    // "চরিত্র, ইলম ও সমাজ:" — এই হেডলাইন সরিয়ে ফেলা হয়েছে (ব্যবহারকারীর
    // অনুরোধ অনুযায়ী), তবে নিচের প্রতিটা আমলের বিষয়বস্তু অক্ষত রাখা হয়েছে,
    // শুধু নির্দিষ্ট সময়ে (গভীর রাতে নয়) দেখানো হচ্ছে।
