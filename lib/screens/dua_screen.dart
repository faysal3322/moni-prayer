...
class _DuaTimeTabState extends State<_DuaTimeTab> {
  ...
  final List<Map<String, dynamic>> _times = [
    ...
    },
    {
      ...
      'desc': 'উসামা বিন যায়েদ (রা.) বলেন: রাসূল ﷺ কাবার ভেতরে প্রবেশ করে দোয়া করেছেন এবং বের হওয়া পর্যন্ত নামাজ পড়েননি। বের হয়ে দুই রাকাত নামাজ পড়েছেন এবং বলেছেন: এটিই কিবলা। — বুখারী ৪২৮৯\n\nকাবার ভেতরে প্রবেশের সুযোগ পেলে মনের সব আরজি পেশ করুন।',
      'color': const Color(0xFFE65100),
    },
    {
      'icon': '🏔️',
      ...
      'desc': 'রাসূল ﷺ সাফায় উঠে কিবলামুখী হয়ে বলতেন:\n\nلَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ لَا شَرِيكَ لَهُ، لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ وَهُوَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ، لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ أَنْجَزَ وَعْدَهُ وَنَصَرَ عَبْدَهُ وَهَزَمَ الْأَحْزَابَ وَحْدَهُ\n"লা ইলাহা ইল্লাল্লাহু ওয়াহদাহু লা শারিকা লাহু, লাহুল মুলকু ওয়ালাহুল হামদু ওয়াহুয়া আলা কুল্লি শাইয়িন কাদীর। লা ইলাহা ইল্লাল্লাহু ওয়াহদাহু আনজাযা ওয়া\'দাহু ওয়ানাসারা আবদাহু ওয়াহাযামাল আহযাবা ওয়াহদাহ।"\nঅর্থ: আল্লাহ ছাড়া কোনো ইলাহ নেই, তিনি একা তাঁর প্রতিশ্রুতি পূরণ করেছেন, তাঁর বান্দাকে সাহায্য করেছেন এবং একাই শত্রুদলকে পরাজিত করেছেন। — মুসলিম ১২১৮\n\nসাফা ও মারওয়ায় উঠে তিনবার এই যিকর করুন এবং মাঝে মাঝে দোয়া করুন।',
      'color': const Color(0xFFE65100),
    },
    {
      'icon': '🌟',
      ...
      'desc': 'রাসূল ﷺ বলেছেন: "আল্লাহর ফেরেশতারা পৃথিবীতে ঘুরে বেড়ান। যখন কোনো যিকরের মজলিস খুঁজে পান, তখন বলেন: আসো, তোমাদের প্রয়োজন পূরণ করো।" — মুসলিম ২৬৮৯\n\nযিকরের মজলিসে যোগ দিন এবং দোয়া করুন।',
      'color': const Color(0xFFE65100),
    },
    {
      'icon': '🤲',
    ...
    },
    {
      ...
      'desc': 'রাসূল ﷺ বলেছেন: "রমজান মাসে প্রতি রাতে একজন ঘোষক ঘোষণা করেন: হে কল্যাণের অন্বেষণকারী! এগিয়ে আসো। হে অকল্যাণের অন্বেষণকারী! বিরত হও। এই মাসে আল্লাহ অনেককে জাহান্নাম থেকে মুক্ত করেন এবং প্রতি রাতেই এটি হয়।" — তিরমিযী ৬৮২\n\nরমজান মাসে বেশি বেশি দোয়া করুন।',
      'color': const Color(0xFFE65100),
    },
    {
      'icon': '⚔️',
      ...
      'desc': 'রাসূল ﷺ বলেছেন: "দুটি সময়ে দোয়া ফিরিয়ে দেওয়া হয় না: আজানের সময় এবং যুদ্ধ তুঙ্গে থাকার সময় যখন সারিবদ্ধভাবে যুদ্ধ হয়।" — আবু দাউদ ২৫৪০\n\nআল্লাহর পথে জিহাদকারীর দোয়া আল্লাহ কবুল করেন।',
      'color': const Color(0xFFE65100),
    },
    {
      'icon': '✅',
    ...
    },
    {
      ...
      'desc': 'ইবনে উমর (রা.) ছোট জামরায় সাতটি পাথর মেরে প্রতিটিতে তাকবীর বলতেন, তারপর কিবলামুখী হয়ে দীর্ঘ সময় দোয়া করতেন। মধ্যম জামরায়ও তাই করতেন। বড় জামরায় পাথর মেরে চলে যেতেন, দাঁড়াতেন না। — বুখারী ১৭৫১\n\nজামরায় পাথর মারার পর দোয়ার জন্য সময় নিন।',
      'color': const Color(0xFFE65100),
    },
    {
      'icon': '💎',
      ...
      'desc': 'রাসূল ﷺ বলেছেন: "আল্লাহর ইসমে আযম এই আয়াতগুলোতে আছে: সূরা বাকারা আয়াত ২৫৫ (আয়াতুল কুরসি), সূরা আলে ইমরান আয়াত ১-২ এবং সূরা তহা আয়াত ১১১। এই নাম দিয়ে দোয়া করলে আল্লাহ কবুল করেন।" — আহমদ, আবু দাউদ ১৪৯৬\n\nআয়াতুল কুরসি:\nاللَّهُ لَا إِلَهَ إِلَّا هُوَ الْحَيُّ الْقَيُّومُ\n"আল্লাহু লা ইলাহা ইল্লা হুওয়াল হায়্যুল কাইয়্যূম।"\nঅর্থ: আল্লাহ — তিনি ছাড়া কোনো ইলাহ নেই, তিনি চিরঞ্জীব, সর্বসত্তার ধারক।\n\nদোয়ার শুরুতে আল্লাহর গুণবাচক নাম ও প্রশংসা দিয়ে শুরু করুন।',
      'color': const Color(0xFFE65100),
    },
  ];
