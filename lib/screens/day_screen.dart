...
class _DayScreenState extends State<DayScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text(DateHelper.formatGregorian(
          _dates[_currentIndex], bangla: widget.lang.isBn)),
                  ...
                  children: [
                    if (index > 0)
                      TextButton.icon(
                        ...
                        label: Text(widget.lang.isBn ? 'আগের দিন' : 'Prev',
                    ...
                    if (index < _dates.length - 1)
                      TextButton.icon(
                        ...
                        label: Text(widget.lang.isBn ? 'পরের দিন' : 'Next',
                          style: const TextStyle(color: AppTheme.accent, fontSize: 12)),
                      ),
                  ],
                ),
...
class _PrayerRow extends StatelessWidget {
  ...
  const _PrayerRow({
    required this.name, required this.status, required this.lang,
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: isMissed ? AppTheme.missed.withOpacity(0.5)
      ...
      child: Row(
        children: [
          Expanded(child: Row(children: [
            Icon(isPrayed ? Icons.check_circle
